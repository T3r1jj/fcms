...
describe('component', () => {
    ...
    beforeEach(() => {
        props = { name: "Record name", id: "1", description: "some description", meta: [], versions: [], backups: [], hierarchyTooltipEnabled: true }
    })
    ...
    describe('rendering', () => {
        ...
        it("renders meta records if there are any", () => {
            const propsWithMeta: IRecordProps = { ...props, meta: [{ ...props, id: "Meta1", name: "Meta name 1" }, { ...props, id: "Meta2", name: "Meta name 2" }] }
        ...
        it("renders version records if there are any", () => {
            const propsWithVersions: IRecordProps = { ...props, versions: [{ ...props, id: "V1", tag: "Version tag 1" }, { ...props, id: "V2", tag: "Version tag 2" }] }
